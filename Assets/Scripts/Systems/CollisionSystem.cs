...
public class CollisionSystem : ComponentSystem
{
    ...
    {
        _collisionQuery = GetEntityQuery(typeof(ActorColliderData),  typeof(Transform));
    }
    protected override void OnUpdate()
    {
            ...
            (Entity entity, CollisionAbility collisionAbility, ref ActorColliderData colliderData) =>
        {
            ...
            int size = 0;
            collisionAbility.detectedCollisions.Clear();
            ...
            switch (colliderData.ColliderType)
            {
                ...
                case ColliderType.Box:
                    size = Physics.OverlapBoxNonAlloc(colliderData.BoxCenter + position, colliderData.BoxHalfExtents,
                        _results, colliderData.BoxOrientation * rotation);
                    break;
                default:
            ...
            if (size > 0)
            {
                ...
                {
                    collisionAbility.detectedCollisions.Add(_results[i]);
                }
